INSERT INTO `zkwantd1`.`User` (userId, typeOfUser, username, hashedPassword, firstName, infix, lastName, coinBalance, phoneNumber, emailaddress, salt) VALUES (1, 'Huurder', 't01updated7', '', 't01firstName', '', 't01lastName', 0, '0600000001', 't01@fake.com', '');
INSERT INTO `zkwantd1`.`User` (userId, typeOfUser, username, hashedPassword, firstName, infix, lastName, coinBalance, phoneNumber, emailaddress, salt) VALUES (2, 'Huurder', 't02', 't02', 't02firstName', '', 't02lastName', 10, '0600000002', 't02@fake.com', '');

INSERT INTO Message (senderId,receiverId,dateTimeSent,subject,body,archivedBySender,archivedByReceiver,readByReceiver) VALUES (1,
                                                                                                                               2,
                                                                                                                               '2024-01-19 03:14:07',
                                                                                                                               'He',
                                                                                                                               'blabla',
